     ...
     <div className="navbar navbar-default navbar-xs content-group">
        ...
        <div className="navbar-collapse collapse" id="navbar-filter">
          <ul className="nav navbar-nav">
            <li className="active"><a href="#user" data-toggle="tab"><i className="icon-cog3 position-left"></i> {this.props.first}</a></li>
            <li><a href="#inversor" data-toggle="tab"><i className="icon-user position-left"></i>{this.props.second}</a></li>
          </ul>
        </div>
      </div>
