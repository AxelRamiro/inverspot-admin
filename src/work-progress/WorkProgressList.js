...
class WPR extends Component {
  ...
  render() {
    ...
    <tr>
      ...
      <td>
        <a href={`http://192.169.174.96/is-img/${progress.photo}`} data-popup="lightbox">
          <img src={ `http://192.169.174.96/is-img/${progress.photo}` } alt="" className="img-rounded img-preview" />
        </a>
      </td>
      <td>
